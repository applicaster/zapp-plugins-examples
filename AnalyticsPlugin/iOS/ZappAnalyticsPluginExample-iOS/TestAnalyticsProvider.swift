...
open class TestAnalyticsProvider: ZPAnalyticsProvider {
    ...
    // Inititalizes Provider
    public required init() {
        super.init()
    }
    
    // Initializes Provider with the configuration JSON from manifest
    ...
    open override func configureProvider() -> Bool {
        ...
        */
        ...
        /*
         For this example we are settinng up Google Analytics with a static account,
